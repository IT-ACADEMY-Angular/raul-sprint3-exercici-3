...
describe('Function "moviesAverageByCategory"', () => {
  ...
  it('should return a new array, not update the original one', () => {
    expect(moviesAverageByCategory(movies)).not.toEqual(movies);
  });
  ...
  it(' should return the average score of genre selecting only the genre of the films. With 1 decimals! ', () => {
